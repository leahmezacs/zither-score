...
var cloudform_types_2 = require("cloudform-types");
    ...
    TransformFormatter.prototype.format = function (ctx) {
        ...
        var nestedStacks = splitStack_1.default({
            ...
            defaultParameterValues: (_a = {},
                _a[graphql_transformer_common_2.ResourceConstants.PARAMETERS.AppSyncApiId] = cloudform_types_2.Fn.GetAtt(graphql_transformer_common_2.ResourceConstants.RESOURCES.GraphQLAPILogicalID, 'ApiId'),
                _a),
            ...
            importExportPrefix: cloudform_types_2.Fn.Ref(graphql_transformer_common_2.ResourceConstants.PARAMETERS.AppSyncApiId),
    ...
    TransformFormatter.prototype.collectResolversFunctionsAndSchema = function (ctx) {
        ...
        for (var _i = 0, _b = Object.keys(templateResources); _i < _b.length; _i++) {
            ...
            if (resource.Type === 'AWS::AppSync::Resolver') {
                ...
                functionsMap = __assign(__assign({}, functionsMap), (_a = {}, _a[resourceName + ".zip"] = ctx.metadata.get('ElasticsearchPathToStreamingLambda'), _a));
            }
        }
