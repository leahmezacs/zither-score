...
class RelationalDBTemplateGenerator {
    ...
    makeIAMDataSourceRole() {
        return new iam_1.default.Role({
            RoleName: cloudform_1.Fn.Join('-', ['role', cloudform_1.Fn.Ref(ResourceConstants_1.ResourceConstants.PARAMETERS.AppSyncApiId), cloudform_1.Fn.Ref(ResourceConstants_1.ResourceConstants.PARAMETERS.Env)]),
                        ...
                        Statement: [
                            {
                                ...
                                Resource: [cloudform_1.Fn.Ref(ResourceConstants_1.ResourceConstants.PARAMETERS.rdsClusterIdentifier)],
                            },
                            {
                                Effect: 'Allow',
                                Action: ['secretsmanager:GetSecretValue'],
                                Resource: [cloudform_1.Fn.Ref(ResourceConstants_1.ResourceConstants.PARAMETERS.rdsSecretStoreArn)],
                            },
                        ],
                    },
                }),
