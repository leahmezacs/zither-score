...
var Client = /** @class */ (function () {
    ...
    Client.prototype.setup = function () {
        ...
        var completeConnection = function () {
            ...
            connection.on('unsubscribe', function (packet) {
                ...
                steed().map(_this, packet.unsubscriptions, _this.unsubscribeMapTo, function (err) {
                    if (err) {
    ...
    Client.prototype.handleSubscribe = function (packet) {
        ...
        steed().map(this, packet.subscriptions, this.handleEachSub, function (err, authorized) {
            if (err) {
                _this.close(null, err.message);
                return;
            }
    ...
    Client.prototype.close = function (callback, reason) {
        ...
        this._closing = true;
        steed.map(this, Object.keys(this.subscriptions), this.unsubscribeMapTo, function (err) {
            if (err) {
