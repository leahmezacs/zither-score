...
var PluginPlatform = /** @class */ (function () {
    function PluginPlatform() {
        this.pluginDirectories = [constants_1.default.LocalNodeModules, constants_1.default.ParentDirectory, constants_1.default.GlobalNodeModules];
        this.pluginPrefixes = [constants_1.default.AmplifyPrefix];
