...
function getPluginsWithNameAndCommand(pluginPlatform, nameOrAlias, command) {
    ...
    Object.keys(pluginPlatform.plugins).forEach(function (pluginName) {
        pluginPlatform.plugins[pluginName].forEach(function (pluginInfo) {
            ...
            var nameOrAliasMatching = name === nameOrAlias || (aliases && aliases.includes(nameOrAlias));
...
function addPluginPackage(pluginPlatform, pluginDirPath) {
    ...
    if (pluginVerificationResult.verified) {
        ...
        if (pluginPlatform.excluded[pluginInfo_1.manifest.name] && pluginPlatform.excluded[pluginInfo_1.manifest.name].length > 0) {
        ...
        if (pluginPlatform.plugins[pluginInfo_1.manifest.name] && pluginPlatform.plugins[pluginInfo_1.manifest.name].length > 0) {
