...
function verifyInput(pluginPlatform, input) {
    ...
    if (pluginCandidates.length > 0) {
        for (var i = 0; i < pluginCandidates.length; i++) {
            ...
            if ((commands && commands.includes(constants_1.default.HELP)) || (commandAliases && Object.keys(commandAliases).includes(constants_1.default.HELP))) {
            ...
            if (input.command === constants_1.default.PLUGIN_DEFAULT_COMMAND) {
                ...
                if (input.options && input.options[constants_1.default.VERSION] && commands && commands.includes(constants_1.default.VERSION)) {
                    input.command = constants_1.default.VERSION;
                    result.verified = true;
                    break;
                }
                if (input.options && input.options[constants_1.default.HELP] && commands && commands.includes(constants_1.default.HELP)) {
