...
function getHashForResourceDir(dirPath) {
    ...
    return hashElement(dirPath, options).then(function (result) { return result.hash; });
}
...
function getAllResources(amplifyMeta, category, resourceName, filteredResources) {
    ...
    if (category !== undefined && resourceName !== undefined) {
        ...
        resources = resources.filter(function (resource) { return resource.category === category && resource.resourceName === resourceName; });
    }
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            ...
                                                            if (!(currentamplifyMeta[categoryName][resource] !== undefined && amplifyMeta[categoryName][resource] !== undefined)) return [3 /*break*/, 2];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (providerName) {
                        resourcesToBeCreated = resourcesToBeCreated.filter(function (resource) { return resource.providerPlugin === providerName; });
                        resourcesToBeUpdated = resourcesToBeUpdated.filter(function (resource) { return resource.providerPlugin === providerName; });
                        resourcesToBeDeleted = resourcesToBeDeleted.filter(function (resource) { return resource.providerPlugin === providerName; });
                        allResources = allResources.filter(function (resource) { return resource.providerPlugin === providerName; });
                    }
                    return [2 /*return*/, {
                            resourcesToBeCreated: resourcesToBeCreated,
                            resourcesToBeUpdated: resourcesToBeUpdated,
