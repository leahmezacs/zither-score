...
function editorSelection(defaultEditor) {
    return __awaiter(this, void 0, void 0, function () {
        var editorQuestion, editorSelected;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    defaultEditor = editors.findIndex(function (editor) { return editor.value === defaultEditor; }) > -1 ? defaultEditor : undefined;
                    editorQuestion = {
                        type: 'list',
                        name: 'editorSelected',
                    ...
                    return [4 /*yield*/, inquirer.prompt(editorQuestion)];
                case 1:
                    editorSelected = (_a.sent()).editorSelected;
                    return [2 /*return*/, editorSelected];
            }
        });
    });
}
...
function normalizeEditor(editor) {
    if (editor) {
        ...
        editor = editors.findIndex(function (editorEntry) { return editorEntry.value === editor; }) > -1 ? editor : undefined;
    }
    return editor;
}
module.exports = {
