...
function copyBatch(context, jobs, props, force, writeParams) {
    return __awaiter(this, void 0, void 0, function () {
        var template, prompt, filesystem, confirm, shouldGenerate, index, job, params, jsonString;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    template = context.template, prompt = context.prompt, filesystem = context.filesystem;
                    ...
                    _a.label = 1;
                case 1:
                    if (!(index < jobs.length)) return [3 /*break*/, 4];
                    job = jobs[index];
                    // safety check
                    if (!job) {
                        return [3 /*break*/, 3];
                    }
                    return [4 /*yield*/, shouldGenerate(job.target, force)];
                case 2:
                    ...
                    if (_a.sent()) {
                        ...
                        if (writeParams && job.paramsFile) {
                            params = writeParams && Object.keys(writeParams) && Object.keys(writeParams).length > 0 ? writeParams : props;
                            jsonString = JSON.stringify(params, null, 4);
