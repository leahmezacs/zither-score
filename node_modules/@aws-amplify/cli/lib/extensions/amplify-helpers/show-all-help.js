"use strict";
var showHelp = require('./show-help').showHelp;
var listCategories = require('./list-categories').listCategories;
function showAllHelp(context) {
    context.print.info('');
    var header = 'amplify <command> <subcommand>';
    var commands = [
        {
            name: 'init',
...
//# sourceMappingURL=../../../src/lib/extensions/amplify-helpers/show-all-help.js.map