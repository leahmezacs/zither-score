...
function run(context) {
    return __awaiter(this, void 0, void 0, function () {
        var pluginPlatform, plugins, excluded, generalInfo, options, answer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    options = [plugins, excluded, generalInfo];
...
function listPluginCollection(context, collection) {
    return __awaiter(this, void 0, void 0, function () {
        var all, options, toList, answer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    all = 'all';
                    options = Object.keys(collection);
                    if (!(options.length > 0)) return [3 /*break*/, 3];
                    toList = options[0];
