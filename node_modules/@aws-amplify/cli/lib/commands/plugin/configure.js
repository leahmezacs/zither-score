        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    exit = 'save & exit';
                    options = [pluginDirectories, pluginPrefixes, maxScanIntervalInSeconds, exit];
                    _b.label = 1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    options = [constants_1.default.ParentDirectory, constants_1.default.LocalNodeModules, constants_1.default.GlobalNodeModules];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    options = [constants_1.default.AmplifyPrefix];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    all = 'all';
                    options = [pluginDirectories, pluginPrefixes, maxScanIntervalInSeconds, all];
                    return [4 /*yield*/, inquirer_helper_1.default.prompt({
                            type: 'list',
                            name: 'selection',
