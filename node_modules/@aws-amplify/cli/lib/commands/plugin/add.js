        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    searchDirPaths = [constants_1.default.ParentDirectory, constants_1.default.LocalNodeModules, constants_1.default.GlobalNodeModules, process.cwd()];
                    searchDirPaths = searchDirPaths.filter(function (dirPath) { return !pluginPlatform.pluginDirectories.includes(dirPath.toString()); });
                    searchDirPaths = searchDirPaths.concat(pluginPlatform.pluginDirectories);
                    candicatePluginDirPaths = searchDirPaths
                        .map(function (dirPath) { return path_1.default.normalize(path_1.default.join(scan_plugin_platform_1.normalizePluginDirectory(dirPath), inputPath)); })
                        .filter(function (pluginDirPath) { return fs_extra_1.default.existsSync(pluginDirPath) && fs_extra_1.default.statSync(pluginDirPath).isDirectory(); });
                ...
                case 4:
                    ...
                    options = candicatePluginDirPaths.concat([CANCEL]);
                    return [4 /*yield*/, inquirer_helper_1.default.prompt({
                            type: 'list',
                            name: 'selection',
