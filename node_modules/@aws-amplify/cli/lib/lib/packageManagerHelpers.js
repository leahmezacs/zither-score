...
function getPackageManager() {
    return __awaiter(this, void 0, void 0, function () {
        var yarnLock, yarnLockDir, packageJson, packageJsonDir;
        return __generator(this, function (_a) {
            yarnLock = './yarn.lock';
            yarnLockDir = path.join(process.cwd(), yarnLock);
            packageJson = './package.json';
            packageJsonDir = path.join(process.cwd(), packageJson);
...
function normalizePackageManagerForOS(packageManager) {
    return __awaiter(this, void 0, void 0, function () {
        var isOnWindows;
        return __generator(this, function (_a) {
            isOnWindows = /^win/.test(process.platform);
            if (isOnWindows) {
                if (packageManager === 'yarn') {
                    return [2 /*return*/, 'yarn.cmd'];
                }
                else if (!packageManager) {
                    return [2 /*return*/, undefined];
                }
                return [2 /*return*/, 'npm.cmd'];
            }
...
module.exports = {
    ...
    normalizePackageManagerForOS: normalizePackageManagerForOS,
};
