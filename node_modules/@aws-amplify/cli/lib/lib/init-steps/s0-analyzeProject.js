            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    projectNameQuestion = {
                        ...
                        default: projectName,
                        validate: function (input) { return isProjectNameValid(input) || 'Project name should be between 3 and 20 characters and alphanumeric'; },
                    };
                                ...
                                case 0:
                                    envNameQuestion = {
                                        ...
                                        validate: function (input) {
                                            return !isEnvNameValid(input) ? 'Environment name should be between 2 and 10 characters (only lowercase alphabets).' : true;
                                        },
                                    };
