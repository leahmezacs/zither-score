...
function makeEnumFilterInputObjects(obj, ctx) {
    return obj.fields
        ...
        var name = isList ? graphql_transformer_common_1.ModelResourceIDs.ModelFilterListInputTypeName(typeName) : graphql_transformer_common_1.ModelResourceIDs.ModelFilterInputTypeName(typeName);
        var fields = [];
        fields.push({
            kind: graphql_1.Kind.INPUT_VALUE_DEFINITION,
            name: {
