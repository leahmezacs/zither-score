        ...
        <Carousel>
            ...
            <Carousel.Caption className="carouselstyle">
              <h3>
                <span className="spanstyle2">
                  ...
                  <b className="bstyle2">Create tab.&nbsp;</b>
                </span>
              </h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <Carousel.Caption className="carouselstyle">
              <h3>
                <span className="spanstyle2">
                  Enter your Score&nbsp;<b className="bstyle2">Name:</b>
                </span>
              </h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <Carousel.Caption className="carouselstyle">
              <h3>
                <span className="spanstyle2">
                  Select <b className="bstyle2">Privacy type.</b>
                </span>
              </h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <Carousel.Caption className="carouselstyle">
              <h3>
                <span className="spanstyle2">
                  Select <b className="bstyle2">Category type.</b>
                </span>
              </h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <Carousel.Caption className="carouselstyle">
              <h3>
                <span className="spanstyle2">
                  Click <b className="bstyle2">Submit.</b>
                </span>
              </h3>
            </Carousel.Caption>
          </Carousel.Item>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption className="carouselstyle">
              <h3>
                <span className="spanstyle2">
                  Select any input box to enter any digit 0-7.
                </span>
              </h3>
            </Carousel.Caption>
          </Carousel.Item>
