...
class HomePage extends Component {
  ...
  async handleCreateFeedback() {
    const feedbackCreated = await API.graphql(
      graphqlOperation(mutations.createFeedback, {
        input: {
  ...
  render() {
    return (
      <div id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        {localStorage.getItem("auth") ? <Tutorials /> : <div></div>}

        <div id="about" className="container-fluid">
          <div className="row">
            <div className="col-sm-8">
              <h2>About NumScore</h2>
              <br />
              <h4>
                Our application allows users to create, view, and print music
                scores written in numbered notation called JianPu.
              </h4>
              <br />
            </div>
          </div>
        ...
        <div className="container-fluid bg-grey">
          <div className="row">
            ...
            <div className="col-sm-8">
              ...
              <br />
              <h4>
                <strong>MISSION:</strong> Our mission is to help users to create
                and read music scores written in numbered notation freely.{" "}
              </h4>
              <br />
            </div>
          </div>
